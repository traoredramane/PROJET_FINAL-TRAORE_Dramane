...
<header class="navbar sticky-top bg-dark flex-md-nowrap p-0 shadow" data-bs-theme="dark">
  <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6 text-white" href="#">SITE LYCEE</a>
      ...
      <div class="offcanvas-lg offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
        ...
        <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
          <ul class="nav flex-column">
            ...
            <li class="nav-item">
              <a class="nav-link d-flex align-items-center gap-2" href="inscription.php">
...
?>
            ...
            <!-- <td> <img src="images/<?php echo $user['photo'] ?>" alt="" style="height:40px;width:40px;border-radius:50px;"></td> -->
              ...
              <td><?php echo $user['tuteur'] ?></td>
              <td><?php echo $user['montant'] ?></td>
              <td><?php echo $user['rebouble'] ?></td>
